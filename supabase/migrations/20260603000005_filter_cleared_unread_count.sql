-- Update get_conversations_with_info to exclude pre-clear messages from unread count
-- After clearing a conversation, only messages received after cleared_at count as unread.
